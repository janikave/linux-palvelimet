...
**18:20**: Loin nano-editorilla osoite-hakemistoon index.html-tiedoston, ja kopioin sinne validin HTML-pohjan[^1], mitä vähän muokkasin (tällä hetkellä tarpeettomat osat pois).
...
**21:00**: Jatkoin tehtävää ja päätin luettuani muutamia artikkeleita[^2] ja ohjeita[^3] vaihtaa omasta kotikansiosta var-hakemiston www-alahakemistoon[^4]. 
...
**22:10**: Rupesin taas katselemaan ongelman juurta, tällä kertaa NameCheapin sivuilta[^5]. Täältä myös löytyi ratkaisu ongelmaan: Avdanced DNS-osion Host Records -kohdassa puuttui A-tietue! Tein sitten sellaisen ja sivusto rupesikin toimimaan. 
...
[^1]: Lazaris, Louis: 2023-09-12. HTML5 Template: A Basic Boilerplate for Any Project. https://www.sitepoint.com/a-basic-html5-template/

[^2]: Veeble Hosting: 2025-04-08. How to setup Apache Web Server to host a website in Linux. https://www.veeble.com/kb/how-to-setup-apache-to-host-a-website-in-linux/

[^3]: Ask Ubuntu: 2014-02-04. Problems with the /var/www folder. https://askubuntu.com/questions/416399/problems-with-the-var-www-folder

[^4]: Geeks for Geeks: 2025-07-24. How to Move File in Linux | mv Command. https://www.geeksforgeeks.org/linux-unix/mv-command-linux-examples/

[^5]: NameCheap: 2024-06-25. My website is down: what to do? https://www.namecheap.com/support/knowledgebase/article.aspx/9568/2194/my-website-is-down-what-to-do/
