...
### Apache.org: Name-based Virtual Host Support - tiivistelmä[^2]
...
### Tero Karvinen: Name Based Virtual Hosts on Apache - tiivistelmä[^3]
...
Käytin näissä harjoituksissa yllä tiivistettyjä artikkeleita[^2][^3] ja Johanna Heinosen tunnilla käyttämää opetusmateriaalia[^4] tiedon hakuun.

### a) Localhost

**Tehtävänanto**: Testaa, että weppipalvelimesi vastaa localhost-osoitteesta.[^1]
...
**Tehtävänanto**: Etsi lokista rivit, jotka syntyvät, kun lataat omalta palvelimeltasi yhden sivun. Analysoi rivit.[^1]
...
Selvittelin googlailemalla[^5] lokin sisältöä ja sen tarkoitusta.
...
**Tehtävänanto**:  Tee uusi name based virtual host. Sivun tulee näkyä suoraan palvelimen etusivulla http://localhost/. Sivua pitää pystyä muokkaamaan normaalina käyttäjänä, ilman sudoa. Tee uusi, laita vanhat pois päältä.[^1]

**18:25** aloitin uuden nimipohjaisen virtuaalipalvelimen luonnin. Käytin tähän Tero Karvisen ohjeistusta.[^3]
...
**Tehtävänanto**: Tee validi HTML5 sivu.[^1]
...
**Tehtävänanto**: Anna esimerkit 'curl -I' ja 'curl' -komennoista.[^1]
...
- Otsakkeet sisältävät tietoa sivun tilasta ja vastauksesta pyyntöön.
  ...
  Selvitin Mozillan Web Docs -kirjastosta otsakkeiden merkityksiä.[^6]
...
[^1]: Karvinen, Tero. h3 Hello Web Server. Kurssin opetusmateriaali. Luettavissa: https://terokarvinen.com/linux-palvelimet/#h3-hello-web-server
[^2]: Apache. Name Based Virtual Host Support. Internet-dokumentaatio. https://httpd.apache.org/docs/2.4/vhosts/name-based.html
[^3]: Karvinen, Tero: 2018-04-10. Name Based Virtual Hosts on Apache – Multiple Websites to Single IP Address. Kurssin opetusmateriaali. https://terokarvinen.com/2018/04/10/name-based-virtual-hosts-on-apache-multiple-websites-to-single-ip-address/
[^4]: Heinonen, Johanna: 2025-09-03. Apache2. Kurssin opetusmateriaali. https://github.com/johannaheinonen/johanna-test-repo/blob/main/linux-03092025.md
[^5]: Girvin, David: 2025-2-20: Understanding the Apache access log: how to view, locate, and analyze. Blogiartikkeli. https://www.sumologic.com/blog/apache-access-log
[^6]: MDN Web Docs - Mozilla. HTTP Headers. Internet-dokumentaatio. https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Headers
