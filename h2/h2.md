...
## Command Line Basics Revisited - tiivistelmä[^1]
...
**22:45** jatkoin ongelman selvittämistä ja otin ChatGPT:n[^2] mukaan tarjoamaan vaihtoehtoja, kun googlaamalla löydetyt vaihtoehdot eivät auttaneet. 
...
Käytin näiden hakemistojen selvittämiseen yllä tiivistämääni Karvisen ohjetta[^1], sekä Johanna Heinosen opetusmateriaalia kurssille[^3].
...
- **bat** - cat-komennon klooni, joka korostaa syntaxin ja sisältää git integraation.[^4][^5]
- **tealdeer** (tldr) - tiivistää man-komennon manuaalit olennaisimpiin kohtiin.[^5]
- **fish** - aloittelijaystävällinen komentorivi.[^5][^6]
...
**17:30** kokeilin tldr-komentoa katsomalla ohjelman tiivistelmän **grep**-komennosta[^7]. 
...
**18:05** rupesin tarkemmin selvittämään putken(pipe, "|") toimintaa ja käyttötarkoitusta[^8].
...
Aluksi tämä ei mennyt läpi, koska lshw piti erikseen ladata. Latauksen jälkeen komento näytti yhteenvedon, joka sisälsi tietoa koneen raudasta ja sen osista, sekä niiden luokituksen ja kuvauksen. Selvitin myös -short ja -sanitize-vaihtoehtojen tarkoitukset[^9]:
...
[^1]: Karvinen, Tero: 2020-02-03. Command Line Basics Revisited. Luettavissa. https://terokarvinen.com/2020/command-line-basics-revisited/?fromSearch=command%20line%20basics%20revisited
[^2]: ChatGPT. Käytetty ongelmanratkontaan sisäänkirjautumisongelmassa. https://chatgpt.com/
[^3]: Heinonen, Johanna: 2025-08-27. Linux Commands. Luettavissa: https://github.com/johannaheinonen/johanna-test-repo/blob/main/linux-27082925.md
[^4]: Gite, Vivek: 2025-03-11. bat Linux command – A cat clone written in Rust. https://www.cyberciti.biz/open-source/bat-linux-command-a-cat-clone-with-written-in-rust/
[^5]: Witowski, Sebastian: 2020-06-18. My Favorite CLI Tools. https://switowski.com/blog/favorite-cli-tools/
[^6]: Fish Shell. Tutorial - fish-shell 4.0.2. documentation. Luettavissa: https://fishshell.com/docs/current/tutorial.html
[^7]: TLDR-komento. tldr grep. Tiivistetty manuaali Linux komentorivillä. 
[^8]: Geeks for Geeks: 2024-07-24. Piping in Unix or Linux. Luettavissa: https://www.geeksforgeeks.org/linux-unix/piping-in-unix-or-linux/
[^9]: Geeks for Geeks: 2024-09-25. lshw command in Linux with Examples. Luettavissa: https://www.geeksforgeeks.org/linux-unix/lshw-command-in-linux-with-examples
